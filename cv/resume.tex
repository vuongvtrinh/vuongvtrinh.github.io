...
\begin{document}
	...
	\hfill {Jan--Jun 2018}
	\begin{innerlist}
		\item Develop symbolic computing software for simulation, optimization and control of sailing yachts,
		\item Familiar with Python, SQL, CasADi and unit-testing.
	\end{innerlist}
	...
	\href{https://trinhvv.github.io/cv/TUM_Lean_Six_Sigma_Yellow_Belt_Certificate.pdf}{\textbf{TUM Lean Six Sigma Yellow Belt Certification}}, \href{https://www.tum.de}{Technische Universit\"{a}t M\"{u}nchen}
	...
	\href{https://kenhtaichinh.herokuapp.com}{\textbf{Blockchain and Cryptoasset Analytics}}
	[\href{https://github.com/trinhvv/blockchain-cryptoasset-analytics}{WebApp}] [\href{https://github.com/trinhvv/trading-analysis-bot}{ChatBot}]\\
	Research: aggregated data viz, statistical analytics and quantitative algorithmic trading for crypto-market \\
	Technology: Python (\emph{Flask, Pandas, Dash}) | AWS (\emph{RDS, EC2}) | Heroku (\emph{Postgres})
