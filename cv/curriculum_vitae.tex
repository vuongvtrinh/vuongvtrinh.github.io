...
\begin{document}
	...
	\begin{innerlist}
		...
		\item Deploy Python (\emph{Flask, Plotly, Pandas, OpenAI Gym}), JS (\emph{Highcharts}), Heroku (\emph{Postgres}), AWS (\emph{RDS}).
	\end{innerlist}
	...
	\begin{innerlist}
		...
		\item Familiar with Python (\emph{CasADi, Numpy, Scipy}), version control (\emph{Git}), bash and unit-testing.
	\end{innerlist}
