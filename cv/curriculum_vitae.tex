...
\begin{document}
	...
	\begin{innerlist}
		...
		\item Familiar with Python (\emph{Pandas, OpenAI Gym}), SQL.
	\end{innerlist}
	...
	Technology: Python (\emph{Flask, Django, Tkinter, Beautiful Soup}) | JS (\emph{Highcharts}) | Heroku (\emph{Postgres}) | API
